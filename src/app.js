...
(function() {
  ...
  module.exports = App = (function() {
    ...
    function App(config1) {
      ...
      ref = ["name", "elasticsearch", "query", "reporters", "validator"];
      ...
      this.worker = App.createWorker(this.config.name, this.config.elasticsearch, this.config.query, this.validator);
      if (this.worker) {
